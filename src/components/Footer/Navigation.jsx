  ...
  return (
    <div className="w-1/6 flex flex-col gap-5">
      ...
      <ul className="text-lg font-semibold list-none flex flex-col gap-4 items-start">
        ...
        <li>
          <a href="#" className="text-base-trand-color hover:text-dark-color">Categories</a>
        </li>
        <li>
          <a href="#" className="text-base-trand-color hover:text-dark-color">Shop</a>
        </li>
        <li>
          <a href="#" className="text-base-trand-color hover:text-dark-color">Contacts</a>
        </li>
      </ul>
    </div>
  )
